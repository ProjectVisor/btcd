...
likely want to use the [rpcclient](github.com/ProjectVisor/xvrd/tree/master/rpcclient)
package which makes use of the [JSON-RPC API](github.com/ProjectVisor/xvrd/tree/master/docs/json_rpc_api.md).
